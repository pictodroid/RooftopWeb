	...
	<body>
		...
		<!-- Feature 1 -->
			<article id="first" class="container box style1 right">
				<a href="#" class="image full"><img src="images/inDistance/Monro.jpg" alt="" /></a>
				<div class="inner">
					<header>
						<h2>Upload Audio<br />
		...
		<!-- Feature 2 -->
			<article class="container box style1 left">
				...
				<div class="inner">
					...
					<p>You won't miss a moment, again, it will be uploaded to your youtube channel, when you got Wifi, no-extra-bother! The link will be sent to who ever you want within a time frame you want.</p>
		...
		<!-- Portfolio -->
			<article class="container box style2">
				<header>
					...
					And don't worry about when or how they are uploaded! Not a moment is lost! </p>
				</header>
